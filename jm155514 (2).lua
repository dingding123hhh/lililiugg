...
local function HeartbeatUpdate()
    ...
    FpsLabel.Text = ("时奶奶个刀刀哈间:"..os.date("%H").."时"..os.date("%M").."分"..os.date("%S"))
end
Start = tick()
...
local about = UITab15:section("主要功能",true)
...
about:Button("给出永久NormalKey(先选择一个NormalKey)",function()
...
about:Toggle("无近端时长", "asdas", true, function(inst)
...
about:Toggle("通知怪物", "NotifyMonster", true, function(inst)
...
about:Toggle("避免任何怪物(测试)", "avoids", true, function(inst)
...
about:Toggle("无眼部感染", "noeyefestation", true, function(inst)
...
about:Toggle("无探照灯", "Searchlights", true, function(inst)
...
about:Toggle("无蒸汽", "steaming", true, function(inst)
...
about:Toggle("钥匙显示", "keys", true, function(Value)
for _, cham in pairs(key) do
			cham.Enabled = Value
		end
end)

about:Toggle("怪物显示", "monsters", true, function(Value)
...
about:Toggle("戏弄室显示", "TricksterRoomdanger", true, function(Value)
...
about:Toggle("怪物储物柜显示", "monsterlocker", true, function(Value)
...
about:Button("禁漫中心",function()
loadstring(game:HttpGet("https://raw.githubusercontent.com/dingding123hhh/lililiugg/main/cooo.lua"))()
end)
...
about:Button("禁漫中心",function()
loadstring(game:HttpGet("https://pastebin.com/raw/eGtAFQy2"))()
end)
